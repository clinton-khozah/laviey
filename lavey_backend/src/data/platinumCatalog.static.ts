export interface PlatinumPlanDto {
  id: string;
  label: string;
  price: string;
  period: string;
...
export interface PlatinumFeatureDto {
  id: string;
  title: string;
  description: string;
}

export interface PlatinumCatalogDto {
  sheetTitle: string;
  heroTitle: string;
  heroTagline: string;
  starEmoji: string;
  ...
  plans: PlatinumPlanDto[];
  features: PlatinumFeatureDto[];
}

export const STATIC_PLATINUM_CATALOG: PlatinumCatalogDto = {
  sheetTitle: 'Platinum',
