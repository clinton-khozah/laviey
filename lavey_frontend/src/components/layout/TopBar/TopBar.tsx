...
export function TopBar({
  ...
  const max = quota?.max ?? "—";
  const showUpgrade = Boolean(onUpgrade);
    ...
    <header className="top-bar">
        ...
        {isPlatinumMember ? (
          ...
          >
            <svg
              ...
              fill="currentColor"
              aria-hidden
              className="top-bar__upgrade-crown"
            >
      ...
      <nav className="top-bar__tabs" aria-label="Feed filter">
        ...
        <span
          ...
          style={{
            transform:
              filter === "for-you" ? "translateX(0)" : "translateX(100%)",
          }}
        />
      </nav>
