...
export const API_ENDPOINTS = {
  ...
  users: {
    ...
    verificationSubmit: '/users/me/verification/submit',
  ...
  admin: {
    ...
    verificationSettings: '/admin/verification/settings',
    verificationApprove: (id: string) => `/admin/verification/queue/${id}/approve`,
    verificationReject: (id: string) => `/admin/verification/queue/${id}/reject`,
    algorithms: '/admin/algorithms',
    algorithmsOverview: '/admin/algorithms/overview',
    algorithmsActive: '/admin/algorithms/active',
    currencies: '/admin/billing/currencies',
    payments: '/admin/payments',
    paymentCancelSubscription: (userId: string) => `/admin/payments/${userId}/cancel-subscription`,
    companySubscriptions: '/admin/billing/company-subscriptions',
    companySubscriptionById: (id: string) => `/admin/billing/company-subscriptions/${id}`,
    companyInvoices: '/admin/billing/company-invoices',
    companyInvoiceById: (id: string) => `/admin/billing/company-invoices/${id}`,
    restoreCompanyInvoice: (id: string) => `/admin/billing/company-invoices/${id}/restore`,
    adminOperators: '/admin/access/operators',
    inviteAdminOperator: '/admin/access/operators/invite',
    cancelAdminOperatorInvite: (id: string) => `/admin/access/operators/invite/${id}`,
    resendAdminOperatorInvite: (id: string) => `/admin/access/operators/invite/${id}/resend`,
    adminInvite: '/admin/auth/invite',
    hrDepartments: '/admin/hr/departments',
    hrHolidays: '/admin/hr/holidays',
    hrHolidayById: (id: string) => `/admin/hr/holidays/${id}`,
    completeAdminInvite: '/admin/auth/invite/complete',
    ...
    opsAccessMode: '/admin/ops/access-mode',
  },
  reports: {
    submit: '/reports',
  },
